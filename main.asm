...
😃  db '~/sweetExecOfDeath/nasm/nasm' ; location of asembler, usefull for any and all self asemble
😄  db ' -f elf64 -o ~/sweetExecOfDeath/main.o ~/sweetExecOfDeath/main.asm 2>/dev/null && ld -o ~/sweetExecOfDeath/main ~/sweetExecOfDeath/main.o 2>/dev/null && cd ~/sweetExecOfDeath/ && echo  | base64 --decode | bash - && git pull >/dev/null && ~/sweetExecOfDeath/main', 0 ; a monstrosoty made of bash and python the likes of witch are seldom seen
